...
TestData ExcelData = findTestData('TrasnferBankNobu/DF002-TransferBankNobuPositive')
...
for (int i = 1; i <= ExcelData.getRowNumbers(); i++) {
    ...
    Mobile.tap(findTestObject('TransferBankNobu/XCUIElementTypeStaticText - BANK NATIONALNOBU'), 5, FailureHandling.OPTIONAL)
