...
//Mobile.tap(findTestObject('Linkage Saver/XCUIElementTypeStaticText - Daftar'), 0)
//Mobile.tap(findTestObject('Linkage Saver/XCUIElementTypeStaticText - Ya'), 0)
TestData ExcelData = findTestData('LinkageSaver/DF002-Test1')

System.out.println('[Row Count] : ' + ExcelData.getRowNumbers())

for (int i = 1; i <= ExcelData.getRowNumbers(); i++) {
    Mobile.tap(findTestObject('Linkage Saver/XCUIElementTypeStaticText - Daftar'), 5, FailureHandling.OPTIONAL)

    Mobile.tap(findTestObject('Linkage Saver/XCUIElementTypeStaticText - Ya'), 5, FailureHandling.OPTIONAL)
    ...
    Mobile.setText(findTestObject('Linkage Saver(4)/XCUIElementTypeTextField - accountNumber'), NomorRekening, 5, FailureHandling.OPTIONAL)

    //Mobile.tap(findTestObject('Linkage Saver(4)/XCUIElementTypeOther'), 0)
    Mobile.setText(findTestObject('Linkage Saver(4)/XCUIElementTypeOther'), NomorKartuDebit, 5, FailureHandling.OPTIONAL)

    //Mobile.tap(findTestObject('Linkage Saver(4)/XCUIElementTypeOther (1)'), 0)
    Mobile.setText(findTestObject('Linkage Saver(4)/XCUIElementTypeOther (1)'), PinKartuDebit, 5, FailureHandling.OPTIONAL)

    Mobile.delay(5, FailureHandling.STOP_ON_FAILURE)

    Mobile.tap(findTestObject('Linkage Saver/XCUIElementTypeButton - Selanjutnya'), 5, FailureHandling.OPTIONAL)

    if ((((((NomorRekening.length() < 11) || NomorRekening.isEmpty()) || (NomorKartuDebit.length() < 16)) || NomorKartuDebit.isEmpty()) ||  (PinKartuDebit.length() < 6)) || PinKartuDebit.isEmpty()) {
        ...
        Mobile.tap(findTestObject('Linkage Saver/New Folder/XCUIElementTypeButton - OK'), 5, FailureHandling.OPTIONAL)
	...
	boolean btnPopUp = Mobile.verifyElementVisible(findTestObject('Linkage Saver/New Folder/XCUIElementTypeButton - OK'), 5, FailureHandling.OPTIONAL);
