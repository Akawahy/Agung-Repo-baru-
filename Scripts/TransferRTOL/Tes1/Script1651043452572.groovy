...
TestData ExcelData = findTestData('TransferRTOL/DF001-TransferRTOL')
...
for (int i = 1; i <= ExcelData.getRowNumbers(); i++) {
    ...
    Mobile.tap(findTestObject('TransferAntarBank/XCUIElementTypeStaticText - BANK BCA'), 5, FailureHandling.OPTIONAL)
    ...
    Mobile.tap(findTestObject('TransferAntarBank/XCUIElementTypeStaticText - RTOL - Rp6.500'), 5, FailureHandling.OPTIONAL)
