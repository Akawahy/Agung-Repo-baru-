...
TestData ExcelData = findTestData('TransferSKN/DF001-TransferSKNPositive')
...
for (int i = 1; i <= ExcelData.getRowNumbers(); i++) {
    ...
    Mobile.tap(findTestObject('TransferAntarBank/XCUIElementTypeStaticText - SKNLLG - Rp2.900'), 5, FailureHandling.OPTIONAL)
