...
Mobile.tap(findTestObject('NeopayUnregistered/OR001-ButtonDaftar'), 0)

Mobile.tap(findTestObject('NeopayUnregistered/OR006-ButtonTidak'), 0)

Mobile.tap(findTestObject('NeopayUnregistered/OR002-ButtonYa'), 0)

TestData ExcelData = findTestData('UnregisterNeopay/DF001-UnregisterNeopay')
