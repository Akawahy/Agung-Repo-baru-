...
TestData ExcelData = findTestData('RegisterFirstDownloader/DF008-FirstDownloaderPositive')
...
for (int i = 1; i <= ExcelData.getRowNumbers(); i++) {
    ...
    //Mobile.tap(findTestObject('eamil1/XCUIElementTypeTextField - numberHandphone'), 5, FailureHandling.OPTIONAL)
    //Mobile.delay(10, FailureHandling.STOP_ON_FAILURE)
    Mobile.setText(findTestObject('eamil1/XCUIElementTypeTextField - textFieldEmail'), AlamatEmail, 5, FailureHandling.OPTIONAL)

    //Mobile.setText(findTestObject('eamil1/XCUIElementTypeTextField - numberHandphone'), NomorHandphone, 5, FailureHandling.OPTIONAL)
    ...
    //Mobile.delay(5, FailureHandling.STOP_ON_FAILURE)
    //Mobile.tap(findTestObject('eamil1/XCUIElementTypeTextField - textFieldEmail'), 5, FailureHandling.OPTIONAL)
    Mobile.setText(findTestObject('eamil1/XCUIElementTypeTextField - numberHandphone'), NomorHandphone, 5, FailureHandling.OPTIONAL)
    ...
    Mobile.tap(findTestObject('RegisterFirstDownloader/OR005-ButtonSelanjutnya'), 0, FailureHandling.OPTIONAL)
    ...
    boolean textInvalidEmail = Mobile.verifyElementVisible(findTestObject('Email FirstDownloader/XCUIElementTypeStaticText - Masukkan format email yang sesuai'), 
    ...
    if ((NomorHandphone.length() < 6) || textInvalidEmail) {
        println('screenshot')
    ...
    boolean btnPopUp = Mobile.verifyElementVisible(findTestObject('Email FirstDownloader/XCUIElementTypeButton - OK'), 5, 
        FailureHandling.OPTIONAL)

    if (btnPopUp) {
        //mobile tap ok
        Mobile.tap(findTestObject('Email FirstDownloader/XCUIElementTypeButton - OK'), 5, FailureHandling.OPTIONAL)
    ...
    Mobile.setText(findTestObject('eamil1/XCUIElementTypeTextField - fullName'), NamaLengkap, 5, FailureHandling.OPTIONAL)

    Mobile.delay(3, FailureHandling.STOP_ON_FAILURE)

    String InputNama = Mobile.getText(findTestObject('eamil1/XCUIElementTypeTextField - fullName'), 5, FailureHandling.OPTIONAL)
    ...
    //if (!InputNama.equals(NamaLengkap)) {
    //Mobile.takeScreenshot('', FailureHandling.STOP_ON_FAILURE)
    //Mobile.tap(findTestObject('Register/New Folder (5)/XCUIElementTypeButton - ic now back'), 0)
    //continue
    //}
    ...
    //Mobile.tap(findTestObject('Register/New Folder (6)/XCUIElementTypeStaticText - 1'), 0)
    //println('PinDariInput' + pin)
    ...
    // Mobile.tap(findTestObject('New Folder (3)/XCUIElementTypeButton - ic now eye closed (1)'), 0, FailureHandling.OPTIONAL)
